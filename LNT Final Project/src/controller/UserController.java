...
public class UserController {
    ...
    public void insertDefaultUsers() {
        try {
            boolean result1 = insertUser(new User("admin@gmail.com", "admin"));
            boolean result2 = insertUser(new User("bryan@gmail.com", "bryan"));
            boolean result3 = insertUser(new User("janice@gmail.com", "janice"));
